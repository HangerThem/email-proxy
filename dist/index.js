...
exports.getAdminAllowedOrigins = getAdminAllowedOrigins;
...
const emailClientPath = path_1.default.join(__dirname, "./email-client.js");
...
app.options("/email-client.js", publicOptionsCors);
app.get("/email-client.js", publicOptionsCors, (_req, res) => {
    res.setHeader("Cross-Origin-Resource-Policy", "cross-origin");
    res.sendFile(emailClientPath);
});
...
app.use("/email", emails_1.default);
