...
const STORAGE_ACCESS_KEY = "email_proxy_admin_access_token"
const STORAGE_REFRESH_KEY = "email_proxy_admin_refresh_token"
const STORAGE_BASE_URL_KEY = "email_proxy_admin_base_url"
const STORAGE_BASE_URL_HISTORY_KEY = "email_proxy_admin_base_url_history"
...
export function AdminApiProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo<AdminApiContextValue>(
    () => ({
      ...
      proxyUrl: isConnected && baseUrl ? `${baseUrl}/email` : "-",
      isConnected,
