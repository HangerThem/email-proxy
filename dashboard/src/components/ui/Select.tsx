...
export function Select({
  ...
  const dropdown = isOpen && (
    <div
      ...
      className="z-[101] bg-bg w-full rounded border border-borderStrong bg-bg outline-none"
  ...
  return (
    <div className={cn("relative w-full", className)} onKeyDown={handleKeyDown}>
      <div
        ...
        className={cn(
          "w-full flex rounded border border-borderStrong bg-bg px-3 py-[9px] font-mono text-[12px] text-text outline-none placeholder:text-textMute cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60 focus-visible:ring-offset-2 focus-visible:ring-offset-bg",
