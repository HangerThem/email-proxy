...
const baseClass =
  "inline-flex items-center gap-1.5 whitespace-nowrap rounded border border-transparent font-mono font-medium transition-all duration-150 disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60 focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
